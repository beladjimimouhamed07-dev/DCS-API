...
local function setServerKeySort(key, sortReverse)
	getOptions().serverKeySort = key
	getOptions().serverSortReverse = sortReverse
end

local function getServerKeySort()
	return getOptions().serverKeySort, getOptions().serverSortReverse
end
...
local function setMultiplayerHideNewFlowPopupMenuAnnouncement(bHide)
	local multiplayer = getOptions().multiplayer
	
	multiplayer.hideNewFlowPopupMenuAnnouncement = bHide
end

local function getMultiplayerHideNewFlowPopupMenuAnnouncement()
	local multiplayer = getOptions().multiplayer
	
	return multiplayer.hideNewFlowPopupMenuAnnouncement
end
...
return {
	...
	setMultiplayerHideNewFlowPopupMenuAnnouncement	= saver(setMultiplayerHideNewFlowPopupMenuAnnouncement),
	getMultiplayerHideNewFlowPopupMenuAnnouncement	= getMultiplayerHideNewFlowPopupMenuAnnouncement,
	...
	setServerKeySort			= saver(setServerKeySort),
	getServerKeySort 			= getServerKeySort,
}