...
visual_detection = {
	...
	average_det_time_max_dist_0_for_ground_units = 10.0, --s, average detection time of target ahead at the maximal distance  (for ground units only)
	...
	atmosphere_transparency_factor = {
		...
		fog_transparency_threshold = 0.085 -- with respect to player's ability to detect the target -- 21.11.24 new fogg threshold tune for new fogg
    },
...
detection_by_optic_sensor = {   --for optic sensors only
	...
	--optic_detector_max_dist_time_param_for_ground_units = 30.0,
	
	--optic_detector_full_scan_time_d_for_ground_units = 8.0, 
	--optic_detector_full_scan_time_k_for_ground_units = 0.6,
}
