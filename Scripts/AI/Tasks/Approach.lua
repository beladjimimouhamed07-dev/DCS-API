...
FSM = {
	...
	[States.MOVING_TO] = {
		{condition = {operator = "and", operands = {Conditions.IF_ON_APPROACH_COURSE, 
			{operator = "or", operands = {Conditions.IF_MINIMAL_ROLL, Conditions.IF_WINGOVER_DIVE_APPROACH}}
			}}, new_state = States.FINAL, period = 1.0},
