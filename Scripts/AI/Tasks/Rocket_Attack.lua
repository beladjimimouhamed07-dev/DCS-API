...
Conditions = {
	...
	IF_PLANE_AHEAD = 17,
	IF_EGRESS_NEEDED = 18,
	IF_EGRESS_FINISHED = 19,
	IF_TOSS_ATTACK_CLIMB_POINT = 20,
}
...
Subtasks = {
	...
	TIMER = 12,	
	BREAKAWAY = 13,	
	MID_AIR_COLLISION_AVOIDANCE = 14,
	EGRESS = 15,
	TOSS_CLIMB = 16,
}
...
SubtasksByState = {
	...
	[States.AIMING_TOSS] = {Subtasks.TOSS_CLIMB, Subtasks.AIMING_DIR, Subtasks.FIRING},
}
...
FSM = {
	...
	[States.MOVING_ON_TARGET_AND_WAITING_FOR_SIGHT] = {
		{condition = {operator = "and", operands = {Conditions.IF_SIGHT_READY,Conditions.IF_MINIMAL_ROLL}}, new_state = States.AIMING_DIR},
		{condition = Conditions.IF_PLANE_AHEAD, new_state = States.MID_AIR_COLLISION_AVOIDANCE, action = 'PUSH' },
		{condition = Conditions.ON_BREAKAWAY_POSITION, new_state = States.BREAKAWAY},
		{condition = Conditions.IF_TARGET_DESTROYED, new_state = States.BREAKAWAY},
		{condition = Conditions.IF_TURN_TO_TARGET_IMPOSSIBLE, new_state = States.BREAKAWAY}
	...
	[States.AIMING_TOSS] = {
		{condition = {subtask = Subtasks.FIRING, status = SubtaskStates[Subtasks.FIRING].RELEASE_FINISHED}, new_state = States.EGRESS},
		{condition = Conditions.IF_TARGET_DESTROYED, new_state = States.BREAKAWAY},		
		{condition = Conditions.IF_PLANE_AHEAD, new_state = States.MID_AIR_COLLISION_AVOIDANCE, action = 'PUSH' },
	},
	[States.EGRESS] = {
