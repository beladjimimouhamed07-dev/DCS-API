...
States = {
	...
	BREAKAWAY = 11,
	MOVING_TO_TARGET_CLIMB_AND_MISSILE_FIRING = 12
}
...
SubtasksByState = {
	...
	[States.MOVING_TO_TARGET_CLIMB_AND_MISSILE_FIRING] = {Subtasks.MOVING_TO_TARGET_HOR, Subtasks.CLIMBING_TO_TOSS_ANGLE, Subtasks.VELOCITY_HOLDING, Subtasks.MISSILE_FIRING}
}
...
FSM = {
	...
	[States.MOVING_TO_TARGET_HOR] = {
		--dive start
		{condition = {operator = "and", operands = {Conditions.IF_MINIMAL_ROLL, Conditions.IF_CAN_DIVE, Conditions.IF_DIVE_NEED, Conditions.IF_ON_DIVE_START_POSITION, {operator = "not", operand = Conditions.IF_TOSS_NEED}} }, new_state = States.MOVING_ON_TARGET},		
		{condition = {operator = "and", operands = {Conditions.IF_MINIMAL_ROLL, Conditions.IF_CAN_DIVE, {operator = "not", operand = Conditions.IF_DIVE_NEED}, Conditions.IF_ON_LAUNCH_DISTANCE_AFTER_DIVE_ON_TIME, {operator = "not", operand = Conditions.IF_TARGET_IN_MISSILE_ANGLES_IN_HOR_FLIGHT_AFTER_DIVE_ON_TIME}, {operator = "not", operand = Conditions.IF_TOSS_NEED} } }, new_state = States.MOVING_ON_TARGET},
		{condition = {operator = "and", operands = {Conditions.IF_MINIMAL_ROLL, Conditions.IF_CAN_DIVE, {operator = "not", operand = Conditions.IF_DIVE_NEED}, Conditions.IF_TARGET_ELEVATION_TOO_SMALL}, {operator = "not", operand = Conditions.IF_TOSS_NEED}}, new_state = States.MOVING_ON_TARGET},
		...
		--breakaway
		{condition = Conditions.IF_TOO_CLOSE, new_state = States.APPROACHING},
		{condition = Conditions.IF_TARGET_DESTROYED, new_state = States.BREAKAWAY},
		{condition = Conditions.IF_TURN_TO_TARGET_IMPOSSIBLE, new_state = States.BREAKAWAY},
		-- climb start for toss fire
		{condition = {operator = "and", operands = {Conditions.IF_MINIMAL_ROLL, Conditions.IF_TOSS_NEED, Conditions.IF_ON_TOSS_PULL_POINT} }, new_state = States.MOVING_TO_TARGET_CLIMB_AND_MISSILE_FIRING},		
		
	},
	[States.MOVING_ON_TARGET] = {
		{condition = {operator = "and", operands = {Conditions.IF_MINIMAL_ROLL, Conditions.IF_ON_LAUNCH_DISTANCE, Conditions.IF_TARGET_IN_MISSILE_ANGLES, Conditions.IF_TARGET_IN_ANGLES, {operator = "not", operand = Conditions.IF_TOSS_NEED}}}, new_state = States.MOVING_ON_TARGET_AND_MISSILE_FIRING},
		--Mid-air collision avoidance
		{condition = Conditions.IF_PLANE_AHEAD, new_state = States.MID_AIR_COLLISION_AVOIDANCE, action = 'PUSH' },
		--breakaway
		{condition = Conditions.IF_TOO_CLOSE, new_state = States.APPROACHING},
		...
		{condition = Conditions.IF_TURN_TO_TARGET_IMPOSSIBLE, new_state = States.BREAKAWAY},
		{condition = {operator = "and", operands = {Conditions.IF_MINIMAL_ROLL, Conditions.IF_ON_LAUNCH_DISTANCE, Conditions.IF_TARGET_IN_MISSILE_ANGLES, Conditions.IF_TARGET_IN_ANGLES, {operator = "and", operand = Conditions.IF_TOSS_NEED}}}, new_state = States.MOVING_TO_TARGET_CLIMB_AND_MISSILE_FIRING},
	},
	[States.MOVING_TO_TARGET_HOR_AND_MISSILE_FIRING] = {
		...
		{condition = Conditions.IF_PLANE_AHEAD, new_state = States.MID_AIR_COLLISION_AVOIDANCE, action = 'PUSH' },
		--breakaway
		{condition = {operator = "and", operands = {Conditions.IF_TOO_CLOSE, {subtask = Subtasks.MISSILE_FIRING, status = SubtaskStates[Subtasks.MISSILE_FIRING].LAUNCH_NOT_STARTED}}}, new_state = States.APPROACHING},
	...
	[States.MOVING_TO_TARGET_CLIMB_AND_MISSILE_FIRING] = 
	{
		--after launch
		{condition = {operator = "and", operands = {{operator = "not", operand = Conditions.IF_FIRE_AND_FORGET_MISSILE}, {subtask = Subtasks.MISSILE_FIRING, status = SubtaskStates[Subtasks.MISSILE_FIRING].LAUNCH_FINISHED}}}, new_state = States.MOVING_ON_TARGET_AND_TARGET_ILLUMINATION},
		{condition = {operator = "and", operands = {Conditions.IF_FIRE_AND_FORGET_MISSILE, {subtask = Subtasks.MISSILE_FIRING, status = SubtaskStates[Subtasks.MISSILE_FIRING].LAUNCH_FINISHED}}}, new_state = States.WAITING_AFTER_LAUNCH},
