    ...
    [Message.wMsgNull] = nil,
		...
		[Message.wMsgLeaderNull] = nil,
			[Message.wMsgLeaderToWingmenNull] = nil,
				...
				-- Tactical turns
				[Message.wMsgLeaderTacTurnLeft30] 		= { _('30 left go'), 			'30 left go'},
				[Message.wMsgLeaderTacTurnRight30] 		= { _('30 right go'), 			'30 right go'},
				[Message.wMsgLeaderTacTurnLeft45] 		= { _('45 left go'), 			'45 left go'},
				[Message.wMsgLeaderTacTurnRight45] 		= { _('45 right go'), 			'45 right go'},
				[Message.wMsgLeaderTacTurnLeft60] 		= { _('60 left go'), 			'60 left go'},
				[Message.wMsgLeaderTacTurnRight60] 		= { _('60 right go'), 			'60 right go'},
				[Message.wMsgLeaderTacTurnLeft90] 		= { _('90 left go'), 			'90 left go'},
				[Message.wMsgLeaderTacTurnRight90] 		= { _('90 right go'), 			'90 right go'},
				[Message.wMsgLeaderTacTurnLeft180] 		= { _('turnabout left go'), 	'turnabout left go'},
				[Message.wMsgLeaderTacTurnRight180] 	= { _('turnabout right go'), 	'turnabout right go'},
				[Message.wMsgLeaderTacTurnRotate180] 	= { _('rotate go'), 			'rotate go'},
				[Message.wMsgLeaderTacTurnShackle] 		= { _('shackle go'), 			'shackle go'},

				[Message.wMsgLeaderHeading000] 			= { _('Heading N(000)'), 		'Heading N(000)'},
				[Message.wMsgLeaderHeading045] 			= { _('Heading NE(045)'), 		'Heading NE(045)'},
				[Message.wMsgLeaderHeading090] 			= { _('Heading E(090)'), 		'Heading E(090)'},
				[Message.wMsgLeaderHeading135] 			= { _('Heading SE(135)'), 		'Heading SE(135)'},
				[Message.wMsgLeaderHeading180] 			= { _('Heading S(180)'), 		'Heading S(180)'},
				[Message.wMsgLeaderHeading225] 			= { _('Heading SW(225)'), 		'Heading SW(225)'},
				[Message.wMsgLeaderHeading270] 			= { _('Heading W(270)'), 		'Heading W(270)'},
				[Message.wMsgLeaderHeading315] 			= { _('Heading NW(315)'), 		'Heading NW(315)'},
				[Message.wMsgLeaderWiden] 				= { _('Widen'), 				'Widen'},
				[Message.wMsgLeaderCloseUp] 			= { _('Close Up'), 				'Close Up'},

				[Message.wMsgLeaderBombWithMe] 			= { _('Bomb after me'), 		'Bomb after me'},
			...
			[Message.wMsgLeaderToServiceNull] = nil,
				...
				[Message.wMsgLeaderToGroundCrewNull] = nil,
					...
					[Message.wMsgLeaderGroundToggleDTC] = '',
		...
		[Message.wMsgALMAZ_Null] = nil,
			...
			[Message.wMsgALMAZ_DANGER_ENG_VIBR]= {_('Danger engine vibration'), 'DANGER_ENG_VIBR'},				--Опасно вибрация двигателя
			...
			[Message.wMsgALMAZ_MIN_FUEL]= {_('Fuel low'), 'MIN_FUEL'},					--Минимальный остаток топлива
		...
		-- MiG-29 VMS (P-591B) messages
		[Message.wMsgMiG29_VMS_Null] = nil,
			[Message.wMsgMiG29_VMS_LEFT_ENGINE_FIRE]				= { _('LEFT ENGINE FIRE'),					'left_engine_fire' },				-- RU: "Пожар левого двигателя"
			[Message.wMsgMiG29_VMS_RIGHT_ENGINE_FIRE]				= { _('RIGHT ENGINE FIRE'),					'right_engine_fire' },				-- RU: "Пожар правого двигателя"
			[Message.wMsgMiG29_VMS_GEARBOX_FIRE]					= { _('GEARBOX FIRE'),						'gearbox_fire' },					-- RU: "Пожар коробки самолётных агрегатов"
			[Message.wMsgMiG29_VMS_550_KILOS_REMAINING]				= { _('550 KILOS REMAINING'),				'550_kilos_remaining' },			-- RU: "Осталось 550 килограммов"
			[Message.wMsgMiG29_VMS_NO_FUEL_BOOST]					= { _('NO FUEL BOOST'),						'no_fuel_boost' },					-- RU: "Нет подкачки топлива"
			[Message.wMsgMiG29_VMS_OVERHEAT_LEFT]					= { _('OVERHEAT LEFT'),						'overheat_left' },					-- RU: "Перегрев левого двигателя"
			[Message.wMsgMiG29_VMS_OVERHEAT_RIGHT]					= { _('OVERHEAT RIGHT'),					'overheat_right' },					-- RU: "Перегрев правого двигателя"
			[Message.wMsgMiG29_VMS_OVERSPEED_LEFT]					= { _('OVERSPEED LEFT'),					'overspeed_left' },					-- RU: "Обороты левого двигателя выше допустимых"
			[Message.wMsgMiG29_VMS_OVERSPEED_RIGHT]					= { _('OVERSPEED RIGHT'),					'overspeed_right' },				-- RU: "Обороты правого двигателя выше допустимых"
			[Message.wMsgMiG29_VMS_GEARBOX_VIBRATION]				= { _('GEARBOX VIBRATION'),					'gearbox_vibration' },				-- RU: "Вибрация коробки самолётных агрегатов выше допустимой"
			[Message.wMsgMiG29_VMS_ALTITUDE_ALTITUDE]				= { _('ALTITUDE ALTITUDE'),					'altitude_altitude' },				-- RU: "Высота опасная"
			[Message.wMsgMiG29_VMS_LOW_OIL_PRESSURE_LEFT]			= { _('LOW OIL PRESSURE LEFT'),				'low_oil_pressure_left' },			-- RU: "Мало давление масла левого двигателя"
			[Message.wMsgMiG29_VMS_LOW_OIL_PRESSURE_RIGHT]			= { _('LOW OIL PRESSURE RIGHT'),			'low_oil_pressure_right' },			-- RU: "Мало давление масла правого двигателя"
			[Message.wMsgMiG29_VMS_OIL_PRESSURE_GEARBOX_LOW]		= { _('OIL PRESSURE GEARBOX LOW'),			'oil_pressure_gearbox_low' },		-- RU: "Мало давление масла коробки самолётных агрегатов"
			[Message.wMsgMiG29_VMS_HIGH_OIL_TEMPERATURE_LEFT]		= { _('HIGH OIL TEMPERATURE LEFT'),			'high_oil_temperature_left' },		-- RU: "Температура масла левого двигателя выше допустимой"
			[Message.wMsgMiG29_VMS_HIGH_OIL_TEMPERATURE_RIGHT]		= { _('HIGH OIL TEMPERATURE RIGHT'),		'high_oil_temperature_right' },		-- RU: "Температура масла правого двигателя выше допустимой"
			[Message.wMsgMiG29_VMS_BOOST_HYDRAULIC_SYSTEM_FAILURE]	= { _('BOOST HYDRAULIC SYSTEM FAILURE'),	'boost_hydraulic_system_failure' },	-- RU: "Отказ бустерной гидросистемы"
			[Message.wMsgMiG29_VMS_MAIN_HYDRAULIC_SYSTEM_FAILURE]	= { _('MAIN HYDRAULIC SYSTEM FAILURE'),		'main_hydraulic_system_failure' },	-- RU: "Отказ общей гидросистемы"
			[Message.wMsgMiG29_VMS_VIBRATION_LEFT]					= { _('VIBRATION LEFT'),					'vibration_left' },					-- RU: "Вибрация левого двигателя"
			[Message.wMsgMiG29_VMS_VIBRATION_RIGHT]					= { _('VIBRATION RIGHT'),					'vibration_right' },				-- RU: "Вибрация правого двигателя"
			[Message.wMsgMiG29_VMS_DC_GENERATOR_FAILURE]			= { _('DC GENERATOR FAILURE'),				'DC_generator_failure' },			-- RU: "Отказ генератора постоянного тока"
			[Message.wMsgMiG29_VMS_IFF_FAILURE]						= { _('IFF FAILURE'),						'IFF_failure' },
			[Message.wMsgMiG29_VMS_SWITCH_IFF_MODE]					= { _('SWITCH IFF MODE'),					'switch_IFF_mode' },				-- RU: "Проверь переключение кодов по времени"
			[Message.wMsgMiG29_VMS_LAUNCH_LAUNCH]					= { _('LAUNCH LAUNCH'),						'launch_launch' },					-- RU: "Пуск разрешён"
			[Message.wMsgMiG29_VMS_UPPER_INLET_OPEN]				= { _('UPPER INLET OPEN'),					'upper_inlet_open' },				-- RU: "Верхний вход воздухозаборника"
			[Message.wMsgMiG29_VMS_AIR_INTAKE_FAILURE_LEFT]			= { _('AIR INTAKE FAILURE LEFT'),			'air_intake_failure_left' },		-- RU: "Отказ автоматики левого воздухозаборника"
			[Message.wMsgMiG29_VMS_AIR_INTAKE_FAILURE_RIGHT]		= { _('AIR INTAKE FAILURE RIGHT'),			'air_intake_failure_right' },		-- RU: "Отказ автоматики правого воздухозаборника"
			[Message.wMsgMiG29_VMS_ENGINE_LEFT_IN_STANDBY_SYSTEM]	= { _('ENGINE LEFT IN STANDBY SYSTEM'),		'engine_left_in_standby_system' },	-- RU: "Левый двигатель на резервной системе"
			[Message.wMsgMiG29_VMS_ENGINE_RIGHT_IN_STANDBY_SYSTEM]	= { _('ENGINE RIGHT IN STANDBY SYSTEM'),	'engine_right_in_standby_system' },	-- RU: "Правый двигатель на резервной системе"
			[Message.wMsgMiG29_VMS_AIR_DATA_SYSTEM_FAILURE]			= { _('AIR DATA SYSTEM FAILURE'),			'air_data_system_failure' },		-- RU: "Отказ системы воздушных сигналов"
			[Message.wMsgMiG29_VMS_CHIPS_LEFT_ENGINE]				= { _('CHIPS LEFT ENGINE'),					'chips_left_engine' },				-- RU: "Стружка в масле левого двигателя"
			[Message.wMsgMiG29_VMS_CHIPS_RIGHT_ENGINE]				= { _('CHIPS RIGHT ENGINE'),				'chips_right_engine' },				-- RU: "Стружка в масле правого двигателя"
			[Message.wMsgMiG29_VMS_FUEL_PRESSURE_LEFT_HIGH]			= { _('FUEL PRESSURE LEFT HIGH'),			'fuel_pressure_left_high' },		-- RU: "Давление топлива левого двигателя выше допустимого"
			[Message.wMsgMiG29_VMS_FUEL_PRESSURE_RIGHT_HIGH]		= { _('FUEL PRESSURE RIGHT HIGH'),			'fuel_pressure_right_high' },		-- RU: "Давление топлива правого двигателя выше допустимого"
			[Message.wMsgMiG29_VMS_CHECK_FUEL_AMOUNT]				= { _('CHECK FUEL AMOUNT'),					'check_fuel_amount' },				-- RU: "Проверь запас топлива"
			[Message.wMsgMiG29_VMS_NO_EQUIPMENT_COOLING]			= { _('NO EQUIPMENT COOLING'),				'no_equipment_cooling' },			-- RU: "Нет охлаждения отсеков"
			[Message.wMsgMiG29_VMS_CHECK_GEAR]						= { _('CHECK GEAR'),						'check_gear' },						-- RU: "Выпусти шасси"
			[Message.wMsgMiG29_VMS_OXYGEN_LOW]						= { _('OXYGEN LOW'),						'oxygen_low' },						-- RU: "Аварийных остаток кислорода"
			[Message.wMsgMiG29_VMS_WING_DROP_TANKS_TRANSFER_FAILURE]= { _('WING DROP TANKS TRANSFER FAILURE'),	'wing_drop_tanks_transfer_failure' },
			[Message.wMsgMiG29_VMS_SKIN_OVERTEMPERATURE]			= { _('SKIN OVERTEMPERATURE'),				'skin_overtemperature' },			-- RU: "Температура торможения предельная"
			[Message.wMsgMiG29_VMS_CANOPY_CANOPY]					= { _('CANOPY CANOPY'),						'canopy_canopy' },					-- RU: "Запри фонарь"
			[Message.wMsgMiG29_VMS_CENTERLINE_TRANSFER_FAILURE]		= { _('CENTERLINE TRANSFER FAILURE'),		'centerline_transfer_failure' },	-- RU: "Невыработка подвесного бака"
			[Message.wMsgMiG29_VMS_OXYGEN_SWITCH_100]				= { _('OXYGEN SWITCH 100'),					'oxygen_switch_100' },				-- RU: "Включи кислород"
			[Message.wMsgMiG29_VMS_CHECK_AEKRAN]					= { _('CHECK AEKRAN'),						'check_AEKRAN' },					-- RU: "Смотри «Экран»"
			[Message.wMsgMiG29_VMS_AEKRAN_FAILURE]					= { _('AEKRAN FAILURE'),					'AEKRAN_failure' },					-- RU: "Отказ «Экрана»"
			[Message.wMsgMiG29_VMS_FEEL_CONTROL_UNIT_FAILURE]		= { _('FEEL CONTROL UNIT FAILURE'),			'feel_control_unit_failure' },		-- RU: "Отказ АРУ"
			[Message.wMsgMiG29_VMS_BINGO_BINGO]						= { _('BINGO BINGO'),						'bingo_bingo' },
			[Message.wMsgMiG29_VMS_RITA_OK]							= { _('RITA OK'),							'rita_OK' },						-- RU: "Блок речевой информации исправен"

			[Message.wMsgMiG29_VMS_BOARD]		= { _('BOARD'),		'board' },		-- RU: "Борт"
			[Message.wMsgMiG29_VMS_0_BEGIN]		= { _('0'),			'0_begin' },	-- RU: "0"
			[Message.wMsgMiG29_VMS_20_BEGIN]	= { _('2'),			'20_begin' },	-- RU: "2"
			[Message.wMsgMiG29_VMS_30_BEGIN]	= { _('3'),			'30_begin' },	-- RU: "3"
			[Message.wMsgMiG29_VMS_40_BEGIN]	= { _('4'),			'40_begin' },	-- RU: "4"
			[Message.wMsgMiG29_VMS_50_BEGIN]	= { _('5'),			'50_begin' },	-- RU: "5"
			[Message.wMsgMiG29_VMS_60_BEGIN]	= { _('6'),			'60_begin' },	-- RU: "6"
			[Message.wMsgMiG29_VMS_70_BEGIN]	= { _('7'),			'70_begin' },	-- RU: "7"
			[Message.wMsgMiG29_VMS_80_BEGIN]	= { _('8'),			'80_begin' },	-- RU: "8"
			[Message.wMsgMiG29_VMS_90_BEGIN]	= { _('9'),			'90_begin' },	-- RU: "9"
			[Message.wMsgMiG29_VMS_100_BEGIN]	= { _('100'),		'100_begin' },	-- RU: "100"
			[Message.wMsgMiG29_VMS_200_BEGIN]	= { _('200'),		'200_begin' },	-- RU: "200"
			[Message.wMsgMiG29_VMS_300_BEGIN]	= { _('300'),		'300_begin' },	-- RU: "300"
			[Message.wMsgMiG29_VMS_400_BEGIN]	= { _('400'),		'400_begin' },	-- RU: "400"
			[Message.wMsgMiG29_VMS_500_BEGIN]	= { _('500'),		'500_begin' },	-- RU: "500"
			[Message.wMsgMiG29_VMS_600_BEGIN]	= { _('600'),		'600_begin' },	-- RU: "600"
			[Message.wMsgMiG29_VMS_700_BEGIN]	= { _('700'),		'700_begin' },	-- RU: "700"
			[Message.wMsgMiG29_VMS_800_BEGIN]	= { _('800'),		'800_begin' },	-- RU: "800"
			[Message.wMsgMiG29_VMS_900_BEGIN]	= { _('900'),		'900_begin' },	-- RU: "900"
			[Message.wMsgMiG29_VMS_0_END]		= { _('0'),			'0_end' },		-- RU: "0"
			[Message.wMsgMiG29_VMS_1_END]		= { _('1'),			'1_end' },		-- RU: "1"
			[Message.wMsgMiG29_VMS_2_END]		= { _('2'),			'2_end' },		-- RU: "2"
			[Message.wMsgMiG29_VMS_3_END]		= { _('3'),			'3_end' },		-- RU: "3"
			[Message.wMsgMiG29_VMS_4_END]		= { _('4'),			'4_end' },		-- RU: "4"
			[Message.wMsgMiG29_VMS_5_END]		= { _('5'),			'5_end' },		-- RU: "5"
			[Message.wMsgMiG29_VMS_6_END]		= { _('6'),			'6_end' },		-- RU: "6"
			[Message.wMsgMiG29_VMS_7_END]		= { _('7'),			'7_end' },		-- RU: "7"
			[Message.wMsgMiG29_VMS_8_END]		= { _('8'),			'8_end' },		-- RU: "8"
			[Message.wMsgMiG29_VMS_9_END]		= { _('9'),			'9_end' },		-- RU: "9"
			[Message.wMsgMiG29_VMS_10_END]		= { _('10'),		'10_end' },		-- RU: "10"
			[Message.wMsgMiG29_VMS_11_END]		= { _('11'),		'11_end' },		-- RU: "11"
			[Message.wMsgMiG29_VMS_12_END]		= { _('12'),		'12_end' },		-- RU: "12"
			[Message.wMsgMiG29_VMS_13_END]		= { _('13'),		'13_end' },		-- RU: "13"
			[Message.wMsgMiG29_VMS_14_END]		= { _('14'),		'14_end' },		-- RU: "14"
			[Message.wMsgMiG29_VMS_15_END]		= { _('15'),		'15_end' },		-- RU: "15"
			[Message.wMsgMiG29_VMS_16_END]		= { _('16'),		'16_end' },		-- RU: "16"
			[Message.wMsgMiG29_VMS_17_END]		= { _('17'),		'17_end' },		-- RU: "17"
			[Message.wMsgMiG29_VMS_18_END]		= { _('18'),		'18_end' },		-- RU: "18"
			[Message.wMsgMiG29_VMS_19_END]		= { _('19'),		'19_end' },		-- RU: "19"
			[Message.wMsgMiG29_VMS_20_END]		= { _('20'),		'20_end' },		-- RU: "20"
			[Message.wMsgMiG29_VMS_30_END]		= { _('30'),		'30_end' },		-- RU: "30"
			[Message.wMsgMiG29_VMS_40_END]		= { _('40'),		'40_end' },		-- RU: "40"
			[Message.wMsgMiG29_VMS_50_END]		= { _('50'),		'50_end' },		-- RU: "50"
			[Message.wMsgMiG29_VMS_60_END]		= { _('60'),		'60_end' },		-- RU: "60"
			[Message.wMsgMiG29_VMS_70_END]		= { _('70'),		'70_end' },		-- RU: "70"
			[Message.wMsgMiG29_VMS_80_END]		= { _('80'),		'80_end' },		-- RU: "80"
			[Message.wMsgMiG29_VMS_90_END]		= { _('90'),		'90_end' },		-- RU: "90"
			[Message.wMsgMiG29_VMS_100_END]		= { _('100'),		'100_end' },	-- RU: "100"
			[Message.wMsgMiG29_VMS_200_END]		= { _('200'),		'200_end' },	-- RU: "200"
			[Message.wMsgMiG29_VMS_300_END]		= { _('300'),		'300_end' },	-- RU: "300"
			[Message.wMsgMiG29_VMS_400_END]		= { _('400'),		'400_end' },	-- RU: "400"
			[Message.wMsgMiG29_VMS_500_END]		= { _('500'),		'500_end' },	-- RU: "500"
			[Message.wMsgMiG29_VMS_600_END]		= { _('600'),		'600_end' },	-- RU: "600"
			[Message.wMsgMiG29_VMS_700_END]		= { _('700'),		'700_end' },	-- RU: "700"
			[Message.wMsgMiG29_VMS_800_END]		= { _('800'),		'800_end' },	-- RU: "800"
			[Message.wMsgMiG29_VMS_900_END]		= { _('900'),		'900_end' },	-- RU: "900"
		[Message.wMsgMiG29_VMS_Maximum] = nil,
