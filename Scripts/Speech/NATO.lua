	...
	sub = {	PlayerAircraftCallsign	= PlayerAircraftCallsign,
			...
			TankerCallsign 			= 	{
											make = function(self, pComm)
												local  callnameIdx, flightNum, aircraftNum = encodeCallsign(pComm:getCallsign())
												return self.sub.TankerCallname:make(pComm:getUnit(),callnameIdx) + self.sub.DigitGroups:make('%d-%d', flightNum, aircraftNum) 
											end,
...
local stringNamesWeapon = Phrases:new({ 
		['AGM_12A'] 	= {_('AGM-12A'), 'AGM-12A'},
		['AGM_12B'] 	= {_('AGM-12B'), 'AGM-12B'},
		['AGM_12C'] 	= {_('AGM-12C'), 'AGM-12C'},
		['AGM_12C_ED'] 	= {_('AGM-12C'), 'AGM-12C'},
		['AGM_45A'] 	= {_('AGM-45A'), 'AGM-45A'},
		['AGM_65A'] 	= {_('AGM-65A'), 'AGM-65A'},
		['AGM_65B'] 	= {_('AGM-65B'), 'AGM-65B'},
		['AGM_65F'] 	= {_('AGM-65F'), 'AGM-65F'},
		['AGM_65H'] 	= {_('AGM-65H'), 'AGM-65H'},
		['AGR_20A']		= {_('M-151'), 'M-151'},
		['AGR_20_M282'] = {_('M-282'), 'M-282'},
		['AGM_65L']		= {_('AGM-65L'), 'AGM-65L'},
		['CBU_99']		= {_('CBU-99'),  'CBU-99'},
		['Mk_83AIR'] 	= {_('Mk-83 Air'), 'Mk-83 Air'},
		['Mk_82Y'] 		= {_('Mk-82Y'), 'Mk-82Y'},
		['Mk_84AIR_GP'] = {_('Mk-84'), 'Mk-84'},
		['Mk_84AIR_TP'] = {_('Mk-84'), 'Mk-84'},
		['Mk_84P'] 		= {_('Mk-84'), 'Mk-84'},
		['Mk_84T'] 		= {_('Mk-84'), 'Mk-84'},
		['AGM_62']		= {_('AGM-62'), 'AGM-62'},
		['AGM_62_I']		= {_('AGM-62'), 'AGM-62'},
		['GBU_32_V_2B']	= {_('GBU-32'), 'GBU-32'},
		['GBU_31_V_2B']	= {_('GBU-31'), 'GBU-31'},
		['GBU_31_V_4B']	= {_('GBU-31'), 'GBU-31'},
		['AGM_154A']	= {_('AGM-154A'), 'AGM-154A'},
		['AGM_84D']		= {_('AGM-84D'), 'AGM-84D'},
		['AGM_84H']		= {_('AGM-84H'), 'AGM-84H'},
		['GBU_54_V_1B']	= {_('GBU-54'), 'GBU-54'},
		['BDU_45']		= {_('BDU-45'), 'BDU-45'},
		['BDU_45B']		= {_('BDU-45B'), 'BDU-45B'},
		['BDU_45LGB']	= {_('BDU-45LGB'), 'BDU-45LGB'},
		['BDU_50HD']	= {_('BDU-50HD'), 'BDU-50HD'},
		['BDU_50LD']	= {_('BDU-50LD'), 'BDU-50LD'},
		['BDU_50LGB']	= {_('BDU-50LGB'), 'BDU-50LGB'},
		['CBU_105']		= {_('CBU-105'),  'CBU-105'},
		
		['HYDRA_70_MK1']	= {_('MK-1'), 'MK-1'},
		['FFAR Mk1 HE']		= {_('MK-1'), 'MK-1'},
		['HYDRA_70_MK5']	= {_('MK-5'), 'MK-5'},
		['FFAR Mk5 HEAT']	= {_('MK-5'), 'MK-5'},
		['HYDRA_70_MK61']	= {_('MK-61'), 'MK-61'},
		['FFAR_Mk61']		= {_('MK-61'), 'MK-61'},
		['HYDRA_70_M151']	= {_('M-151'), 'M-151'},
		['HYDRA_70_M156']	= {_('M-156'), 'M-156'},
		['HYDRA_70_M229']	= {_('M-229'), 'M-229'},
		['HYDRA_70_M259']	= {_('M-259'), 'M-259'},
		['FFAR M156 WP']	= {_('M-156'), 'M-156'},
		['HYDRA_70_WTU1B']	= {_('WTU-1B'), 'WTU-1B'},
		['HYDRA_70_M257']	= {_('M-257'), 'M-257'},
		['HYDRA_70_M274']	= {_('M-274'), 'M-274'},
		['HYDRA_70_M278']	= {_('M-278'), 'M-278'},
		
		-- 3rd parties
		['BRM-1_90MM']		= {_('BRM-1'), 'BRM'},
		['BRM1_90MM_UG']	= {_('BRM-1'), 'BRM'},
		['UG_90MM']			= {_('UG 90MM'), 'UG'},
		['C_701IR']			= {_('C-701IR'), 'C-701IR'},
		['C_701T']			= {_('C-701TV'), 'C-701TV'},
		['C_802AK']			= {_('C-802AK'), 'C-802AK'},
		['CM-802AKG']		= {_('CM-802AKG'), 'CM-802AKG'},
		['CM_802AKG']		= {_('CM-802AKG'), 'CM-802AKG'},
		['CM-802AKG_AI']	= {_('CM-802AKG'), 'CM-802AKG'},
		['LD-10']			= {_('LD-10'), 'LD-10'},
		['LS_6_100']		= {_('LS-6-100'), 'LS-6-100'},
		['LS_6']			= {_('LS-6-250'), 'LS-6-250'},
		['LS_6_500']		= {_('LS-6-500'), 'LS-6-500'},
		['GB-6']			= {_('GB-6'), 'GB-6'},
		['GB-6-HE']			= {_('GB-6-HE'), 'GB-6-HE'},
		['GB-6-SFW']		= {_('GB-6-SFW'), 'GB-6-SFW'},
		['TYPE-200A']		= {_('TYPE-200'), 'Type-200'},
		['Type_200A']		= {_('TYPE-200'), 'Type-200'},		
		['HOT3']			= {_('HOT-3'), 'HOT-3'},
		['HOT3_MBDA']		= {_('HOT-3'), 'HOT-3'},
		
		['BLG66']			= {_('BLG-66'), 'BLG-66'},
		['BLG66_BELOUGA']	= {_('BLG-66'), 'BLG-66'},
		['BLG66_EG']		= {_('BLG-66'), 'BLG-66'},
		['BR_250']			= {_('BR-250'), 'BR-250'},
		['BR_500']			= {_('BR-500'), 'BR-500'},
		['SAMP125LD']		= {_('SAMP-125'), 'SAMP-125'},
		['SAMP250HD']		= {_('SAMP-250-HD'), 'SAMP-250-HD'},
		['SAMP250LD']		= {_('SAMP-250-LD'), 'SAMP-250-LD'},
		['SAMP400HD']		= {_('SAMP-400-HD'), 'SAMP-400-HD'},
		['SAMP400LD']		= {_('SAMP-400-LD'), 'SAMP-400-LD'},
		['BDU_33']			= {_('BDU-33'), 'BDU-33'},
		['BIN_200']			= {_('BIN-200'), 'BIN-200'},
		['BL_755']			= {_('BL-755'), 'BL-755'},
		['BAP_100']			= {_('BAP-100'), 'BAP-100'},
		['BAP-100']			= {_('BAP-100'), 'BAP-100'},
		['BAT-120']			= {_('BAT-120'), 'BAT-120'},
		['FAB_50']			= {_('FAB-50'), 'FAB-50'},
		['FAB_100M']		= {_('FAB-100'), 'FAB-100'},
		['ARF8M3API']		= {_('ARF/8M3 API'), 'ARF8M3 API'},
		['ARF8M3HEI']		= {_('ARF/8M3 HEI'), 'ARF8M3 HEI'},
		['ARF8M3TPSM']		= {_('ARF/8M3 TP-SM'), 'ARF8M3 TP-SM'},
		--['FAB_100']			= {_('FAB-100'), 'FAB-100'},
		--['FAB_250']			= {_('FAB-250'), 'FAB-250'},
		--['FAB_100SV']		= {_('FAB-100'), 'FAB-100'},
		--['FAB-250-M62']		= {_('FAB-250'), 'FAB-250'},
		--['FAB-250M54']		= {_('FAB-250'), 'FAB-250'},
		--['FAB-250M54TU']	= {_('FAB-250'), 'FAB-250'},
...
CallsignJTAC = {
	make = function(self, pComm)
		...
		local callname = self.sub.UnitCallname:make(pUnit, callnameIdx)
		if isHeavyAircraft(pUnit) then
			return callname
		else
			return callname + ' ' + self.sub.DigitGroups:make('%d-%d', flightNum, aircraftNum)
		end
	end,
...
WeaponType = {
	...
	sub = {
		...
		[base.wsType_Bomb]		= Phrases:new({ [base.Mk_81]	= {_('Mk-81'), 'Mk-81'},
												...
												[base.MK_82SNAKEYE] = {_('Mk-82 Snakeye'), 'Mk-82 Snakeye'},
												...
												[base.CBU_103]	= {_('CBU-103'), 'CBU-103'},
												[base.CBU_105]	= {_('CBU-105'), 'CBU-105'},
												[base.CBU_52B]	= {_('CBU-52B'), 'CBU-52B'},
												...
												[base.GBU_31_V_3B]	= {_('GBU-31'), 'GBU-31'},												
												[base.GBU_38]	= {_('GBU-38'), 'GBU-38'},
												[base.M_117]	= {_('M-117'), 'M-117'},
												[base.Durandal] = {_('BLU-107'), 'BLU-107'},												
												[base.FAB_100]	= {_('FAB-100'), 'FAB-100'},
												[base.FAB_250]	= {_('FAB-250'), 'FAB-250'},
												[base.LUU_2B]	= SUU25,
												[base.LUU_19]	= SUU25,
												[base.LUU_2AB]	= SUU25,
												[base.LUU_2BB]	= SUU25}, 'Weapon', {_('bombs'), 'bombs'}),
		[base.wsType_NURS]		= Phrases:new({	[base.Zuni_127]	= {_('Zuni'), 'Zuni'}},
												'Weapon', {_('rockets'), 'rockets'}),
												--{_('rockets'), 'rockets'}, 'Weapon'),
...
NineLineBriefRemarks = {
	make = function(self, _9_line_brief_remarks)
		...
		if _9_line_brief_remarks.weather then
			...
			if 	_9_line_brief_remarks.weather.fog then
			...
			if 	_9_line_brief_remarks.weather.visibility and
				...
				result = result + CR_ + self.sub.visibility:make() + ' ' + self.sub.Number:make(u.adv_round(_9_line_brief_remarks.weather.visibility * u.units.nm.coeff,1))
			end
		end
...
handlersTable = {
	...
	[base.Message.wMsgAWACSContactAffiliation]		= AWACSContactAffiliation,
