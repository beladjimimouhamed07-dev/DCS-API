...
local setMoon = function(self, elevation, azimuth)
	ED_demosceneAPI.setMoonDirection(self.scenePtr, elevation, azimuth)
end
...
local setCelestialBodies = function(self, enable)
	ED_demosceneAPI.setCelestialBodies(self.scenePtr, enable)
end
...
local attachTo = function(self, parent, name, self_name)
	ED_demosceneAPI.attach(self.obj, parent.obj, name, self_name)
end
...
-- exposureCorrection = 0 by default
local setCameraExposureCorrection = function(self, exposureCorrection)
	ED_demosceneAPI.setCameraExposureCorrection(self.obj, exposureCorrection)
end
...
local addWeaponStationToAircraft = function(self, parent, unit_type,station,weapon_clsid,pylon_settings)
	local weapon_station = ED_demosceneAPI.addWeaponStationToAircraft(self.scenePtr, parent.obj, unit_type,station,weapon_clsid,pylon_settings)
...
local getPixelDistancePer10Mils = function(self, hFov)
	return ED_demosceneAPI.getPixelDistancePer10Mils(self.obj, hFov)
end

local setVideoMode = function(self, modeIndex) -- 0 - NO_EFFECT, 1 - INFRARED, 2 - NIGHTVISION
	return ED_demosceneAPI.setCameraVideoMode(self.obj, modeIndex)
end
...
local addCamera = function(self, x,y,z)
	...
	t.setExposureCorrection = setCameraExposureCorrection
	t.getPixelDistancePer10Mils = getPixelDistancePer10Mils
	t.setVideoMode = setVideoMode
	addTransformComponent(t)
	return t
end
...
local function getInterface(scenePtr)
	...
	t.setSun = setSun
	t.setMoon = setMoon
	t.setCelestialBodies = setCelestialBodies
