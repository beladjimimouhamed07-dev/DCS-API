...
local function addEvent(value, key, deviceName)
	...
	if deviceName == "VR Controller" then
		deviceNames = {"Oculus Touch", "WMR Holographic Controller", "VIVE Controller", "HP Motion Controller", "FakeVR Controller", "Valve Index"}
	else
...
addEvent("MGun Left: Trigger"			, "JOY_BTN31"			, "VR Controller")
addEvent("MGun Right: Trigger"			, "JOY_BTN32"			, "VR Controller")
