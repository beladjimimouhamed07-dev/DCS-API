...
--Historical mode Aircraft GREECE--end
	...
	cnt_unit( units.Cars.Car, "S-300PS 5H63C 30H6_tr");
	cnt_unit( units.Cars.Car, "S-300PS 40B6MD sr_19J6");
...
--Historical mode GRveh GREECE
	...
	cnt_unit( units.Cars.Car, "MaxxPro_MRAP");
...
country:add('AFGHANISTAN', _("Afghanistan"), "Afghanistan", "AFG",
  use_default_ranks,
  no_awards,
  no_squadrons
  );

country:add('NEW ZEALAND',_("New Zealand"), "New Zealand", "NZL",
  {
	rank('Second lieutenant', _('Pilot Officer'), 0, {0, 0, 64, 32}),
	rank('First lieutenant', _('Flying Officer'), 15, {0, 32, 64, 32}),
	rank('Captain', _('Flight Lieutenant'), 30, {0, 64, 64, 32}),
  ...
  {
	award('New Zealand Distinguished Service Decoration', _('New Zealand Distinguished Service Decoration'), 800, 'NZL05_Distinguished_Service_Decoration.png'),
	award('New Zealand Bravery Medal', _('New Zealand Bravery Medal'), 1600, 'NZL02_Bravery_Medal.png'),
	award('New Zealand Gallantry Medal', _('New Zealand Gallantry Medal'), 2200, 'NZL03_Gallantry_Medal.png'),
	award('New Zealand Cross', _('New Zealand Cross'),2600, 'NZL04_New_Zealand_Cross.png'),
	award('Victoria Cross for New Zealand', _('Victoria Cross for New Zealand'), 3000, 'NZL01_Victoria_Cross.png'),
  },
  'New Zealand.lua'
);
...
local units =  country:get("RUSSIA").Units
	...
	---------------------------------------------
	--AI FLIGHT MODEL TEST BED
	cnt_unit( units.Planes.Plane, "FULCRUM-LAB");
	---------------------------------------------
...
--Historical mode Aircraft USSR
	...
	cnt_unit( units.Planes.Plane, "MiG-15bis_FC");
	...
	cnt_unit( units.Planes.Plane, "C-47");
	cnt_unit( units.Planes.Plane, "La-7");
...
--Historical mode GRveh UKRAINE--end
	cnt_unit( units.Cars.Car, "M978 HEMTT Tanker"); -- since 2022
	cnt_unit( units.Cars.Car, "MLRS"); -- since 2022
	cnt_unit( units.Cars.Car, "Soldier stinger"); -- since 2022
	cnt_unit( units.Cars.Car, "Stinger comm"); -- since 2022
	cnt_unit( units.Cars.Car, "TPZ"); -- since 2022
	cnt_unit( units.Cars.Car, "NASAMS_Command_Post"); -- since 2022
	cnt_unit( units.Cars.Car, "NASAMS_Radar_MPQ64F1"); -- since 2022
	cnt_unit( units.Cars.Car, "NASAMS_LN_B"); -- since 2022
	cnt_unit( units.Cars.Car, "NASAMS_LN_C"); -- since 2022
	cnt_unit( units.Cars.Car, "M-113"); -- since 2022
	cnt_unit( units.Cars.Car, "Hawk sr"); -- since 2022
	cnt_unit( units.Cars.Car, "Hawk cwar"); -- since 2022
	cnt_unit( units.Cars.Car, "Hawk pcp"); -- since 2022
	cnt_unit( units.Cars.Car, "Hawk tr"); -- since 2022
	cnt_unit( units.Cars.Car, "Hawk ln"); -- since 2022
	cnt_unit( units.Cars.Car, "Gepard"); -- since 2022
	cnt_unit( units.Cars.Car, "M-109"); -- since 2022
	cnt_unit( units.Cars.Car, "MaxxPro_MRAP");
...
--Historical mode Aircraft USA
	...
	cnt_unit( units.Planes.Plane, "F-5E-3_FC");
	cnt_unit( units.Planes.Plane, "F-86F Sabre");
	cnt_unit( units.Planes.Plane, "F-86F_FC");
...
--Historical mode GRveh USA
	...
	cnt_unit( units.Cars.Car, "HL_ZU-23");
	cnt_unit( units.Cars.Car, "MaxxPro_MRAP");
	cnt_unit( units.Cars.Car, "HEMTT_C-RAM_Phalanx");
	cnt_unit( units.Cars.Car, "M1A2C_SEP_V3");
--Historical mode GRveh USA--end
	...
	cnt_unit( units.Cargos.Cargo		  , "gbu_43b_airdrop");
...
--Historical mode GRveh CANADA
	...
	cnt_unit( units.Cars.Car, "FPS-117 ECS");
	cnt_unit( units.Cars.Car, "FPS-117 Dome");
	cnt_unit( units.Cars.Car, "soldier_wwii_br_01");
...
--Historical mode GRveh FRANCE
	...
	cnt_unit( units.Cars.Car, "HL_B8M1");
	cnt_unit( units.Cars.Car, "HL_ZU-23");
	cnt_unit( units.Cars.Car, "LeFH_18-40-105");
...
--Historical mode Heli SWEDEN
	cnt_unit( units.Helicopters.Helicopter, "UH-1H");
--Historical mode Heli SWEDEN--end
...
--Historical mode GRveh GDR
	...
	cnt_unit( units.Cars.Car, "PT_76");
	cnt_unit( units.Cars.Car, "S-60_Type59_Artillery");
	cnt_unit( units.Cars.Car, "BTR-60");
	cnt_unit( units.Cars.Car, "BTR-70");
	cnt_unit( units.Cars.Car, "T-34-85");
...
-- AFGHANISTAN
local units = country:get("AFGHANISTAN").Units
	
--Historical mode Aircraft AFGHANISTAN
	cnt_unit( units.Planes.Plane, "An-26B");
	cnt_unit( units.Planes.Plane, "C-130");
	cnt_unit( units.Planes.Plane, "L-39C");
	cnt_unit( units.Planes.Plane, "MiG-21Bis");
	cnt_unit( units.Planes.Plane, "MiG-23MLD");
	cnt_unit( units.Planes.Plane, "Su-17M4");
--Historical mode Aircraft AFGHANISTAN--end

--Historical mode Heli AFGHANISTAN
	cnt_unit( units.Helicopters.Helicopter, "Mi-24V");
	cnt_unit( units.Helicopters.Helicopter, "Mi-8MT");
	cnt_unit( units.Helicopters.Helicopter, "UH-60A");
--Historical mode Heli AFGHANISTAN--end
	
--Historical mode GRveh AFGHANISTAN
	cnt_unit( units.Cars.Car, "2B11 mortar");
	cnt_unit( units.Cars.Car, "Grad-URAL");
	cnt_unit( units.Cars.Car, "Hummer");
	cnt_unit( units.Cars.Car, "M-113");
	...
	cnt_unit( units.Cars.Car, "Infantry AK Ins");
	cnt_unit( units.Cars.Car, "Soldier RPG");
--Historical mode GRveh AFGHANISTAN--end


-- NEW ZEALAND
local units = country:get("NEW ZEALAND").Units
	
--Historical mode Aircraft NEW ZEALAND
	cnt_unit( units.Planes.Plane, "MosquitoFBMkVI");
	cnt_unit( units.Planes.Plane, "C-130");
	cnt_unit( units.Planes.Plane, "MB-339A");
	cnt_unit( units.Planes.Plane, "F-16C");
	cnt_unit( units.Planes.Plane, "F-16C_50");
	cnt_unit( units.Planes.Plane, "P-51D");
	cnt_unit( units.Planes.Plane, "C-47");
--Historical mode Aircraft NEW ZEALAND--end
	
--Historical mode Heli NEW ZEALAND
	cnt_unit( units.Helicopters.Helicopter, "UH-1H");
--Historical mode Heli NEW ZEALAND--end
	
	cnt_unit( units.Ships.Ship, "HandyWind");
	cnt_unit( units.Ships.Ship, "PERRY");
	cnt_unit( units.Ships.Ship, "speedboat");
	cnt_unit( units.Ships.Ship, "Seawise_Giant");
	cnt_unit( units.Ships.Ship, "Higgins_boat");
--Historical mode Ships NEW ZEALAND
--Historical mode Ships NEW ZEALAND--end
	...
	cnt_unit( units.Cars.Car, "M1126 Stryker ICV");
	cnt_unit( units.Cars.Car, "2B11 mortar");
--Historical mode GRveh NEW ZEALAND
	cnt_unit( units.Cars.Car, "Hummer");
	cnt_unit( units.Cars.Car, "M1043 HMMWV Armament");
	cnt_unit( units.Cars.Car, "M1045 HMMWV TOW");
	cnt_unit( units.Cars.Car, "M-113");
	...
	cnt_unit( units.Cars.Car, "Daimler_AC");
	cnt_unit( units.Cars.Car, "QF_37_AA");
--Historical mode GRveh NEW ZEALAND--end
