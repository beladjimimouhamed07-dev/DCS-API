...
function AirbornGroupsPrepare(squad_name, group_country, airbase_name_start, airbase_name, unit_skill)
    ...
    local groups_descent = {  trooperGroupFirst(points_troopers, 0, unit_skill)
                            ...
                            , trooperGroupFirst(points_troopers, 20, unit_skill)
                            , trooperGroupFirst(points_troopers, 30, unit_skill)
                        }
...
--groups_mission_id = AirbornGroups(200,country.id.USA, "Kobuleti", "Senaki-Kolkhi","Good")
