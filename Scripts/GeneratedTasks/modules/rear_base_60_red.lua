...
function RearBasePrepare(squad_name, unit_skill, position, course)
    if squad_name ~= nil then
        counter_squad = squad_name
    end
...
function RearBase(squad_name, group_country, airbase_name_str_to, unit_skill, course, dist)
    ...
    local groups_to_create = RearBasePrepare(squad_name, unit_skill, pos, course_to_base)
...
--arta = RearBase(nil, country.id.RUSSIA, "Senaki-Kolkhi", "Good", math.rad(-135), 5000)