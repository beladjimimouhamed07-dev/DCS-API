...
local function addPlaneRoutePointsByAirbase(airbase_name_start, airbase_name_target)
    ...
    local points =
    {
        [point_num()] = PointTask(point_start.x,3000,point_start.z,nil,800,nil,FighterSweepTask()),
        [point_num()] = PointTask(point_end.x,3000,point_end.z,nil,800),
    }
...
--groups_mission_id = AirFighterGroups(200,country.id.USA, "Kutaisi", "Senaki-Kolkhi","Good")
