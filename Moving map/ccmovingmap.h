...
SimpleOctTree * __thiscall cockpit::ccMovingMap::check_charts(ccMovingMap *this,uint param_1,double param_2);
void __thiscall cockpit::ccMovingMap::distribute_elements(ccMovingMap *this);
void __thiscall cockpit::ccMovingMap::draw(ccMovingMap *this,ccIndicationRenderParser *param_1,uchar param_2);
...
void __thiscall cockpit::ccMovingMap::render(ccMovingMap *this,ccIndicationRenderParser *param_1,uchar param_2);
