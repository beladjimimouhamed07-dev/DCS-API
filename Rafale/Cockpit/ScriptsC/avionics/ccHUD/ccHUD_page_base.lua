-- ccHUD_page_base.lua - CORRECTED
-- HUD Base Page - Ancrage physique et masques optiques du collimateur
...
-----------------------------------------------------------------------
-- 2. DÉFINITION DES VERTICES COMMUNS (GLASS & FOV)
-----------------------------------------------------------------------
...
-----------------------------------------------------------------------
-- 3. HUD FIELD OF VIEW (FOV) PROJECTIONS (Masque Optique Stencil)
-----------------------------------------------------------------------
...
local function Add_FOV_trapezoid(name, vertices, pos)
    ...
    FOV_lens.controllers      = {{"move_up_down_using_parameter", 0, 0.0063}}
...
-----------------------------------------------------------------------
-- 4. CRÉATION DES COMBINER GLASS (Masque Physique)
-----------------------------------------------------------------------
