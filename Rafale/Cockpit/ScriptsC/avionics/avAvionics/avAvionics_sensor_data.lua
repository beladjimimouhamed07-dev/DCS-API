...
---PARAMTERS FOR THE HUD/INDICATORS----------------------------------------------------------------
	...
	Sensor_Data_Param =	{
							...
							RAFALE_HUD_SPEED_IAS = get_param_handle("RAFALE_HUD_SPEED_IAS"),
							RAFALE_HUD_SPEED_MACH = get_param_handle("RAFALE_HUD_SPEED_MACH"),
							RAFALE_HUD_ALT_BARO_FL = getParamHandle("RAFALE_HUD_ALT_BARO_FL"),
							RAFALE_HUD_ALT_BARO_DU = getParamHandle("RAFALE_HUD_ALT_BARO_DU"),
							RAFALE_HUD_VV_X = get_param_handle("RAFALE_HUD_VV_X"),
							RAFALE_HUD_VV_Y = get_param_handle("RAFALE_HUD_VV_Y"),
							RAFALE_HUD_VV_VALID = get_param_handle("RAFALE_HUD_VV_VALID"),
						-----------------		
