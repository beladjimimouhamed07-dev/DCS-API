...
local function head_pos_default(tab)
	...
	tab.viewAngle = tab.viewAngle  or 100
	tab.hAngle    = tab.hAngle     or  0
	tab.vAngle    = tab.vAngle     or -10
	tab.x_trans   = tab.x_trans    or  0.1
	tab.y_trans   = tab.y_trans    or  0.019003
